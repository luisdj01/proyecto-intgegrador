...
//Mostrar los datos almacenados en la tabla fuente
    ...
    asesor.Nombre, asesor.Apellido_paterno, asesor.Apellido_materno, trabajos.ruta
    FROM trabajos 
...
<div class="col-12" style="text-align: center;">
    <h2><b>Para ver el archivo dar clic sobre el nombre del proyecto</b></h2>
</div><br><br>
<?php
...
while($fila=$ejecutarConsulta->fetch_array()){
    ...
    echo "<tr>";
    echo "<td>".$fila[0]."</td><td><a href=".$fila[12]." target='_blank'>".$fila[1]."</a></td>
    <td>".$fila[2]."</td><td>".$fila[3]." ".$fila[4]."</td><td>".$fila[5]."</td><td>".$fila[6]." ".$fila[7]." ".$fila[8]."</td>
    <td>".$fila[9]." ".$fila[10]." ".$fila[11]."</td><td>
