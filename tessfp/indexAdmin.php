...
<body>
    ...
    <div class="container">
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark" id="Nav">
            <a class="navbar-brand" href="#" style="color: Black;"><img src="img/logo.png" width="150px" height="50px"alt="" srcset=""></a>
            ...
            <div class="col-12" style="text-align: center;">
                ...
                <h1 class="animate__animated animate__backInLeft">
                    <font color="black" size="7">
                        <b>Bienvenido: <?php echo $usuario;?> </b>
                    </font>
                </h1>
                <br>
            ...
            <div class="col-12">
                <form class="row g-3 needs-validation" novalidate>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="password" class="form-control" id="txtPasswordAlumno" placeholder="Contraseña"
                            required>
                        <div class="invalid-feedback">La contraseña es nesesaria</div>
                    </div>
                    <div class="col-md-6">
                        <label for="txtNombreAlumno">Nombre del Alumno</label>
                        <input type="text" class="form-control" id="txtNombreAlumno" placeholder="Nombre del Alumno"
                            required>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="txtAPAlumno" placeholder="Apellido Paterno"
                            required>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="txtAMAlumno" placeholder="Apellido Materno"
                            required>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" class="form-control" id="txtTelAlumno" placeholder="Teléfono Alumno"
                            required>
                        <div class="invalid-feedback">El Teléfono del alumno es nesesario</div>
                    </div>
                    <div class="col-md-6">
                        <label for="txtEmailAlumno">E-mail del alumno</label>
                        <input type="email" class="form-control" id="txtEmailAlumno" placeholder="E-mail Alumno"
                            required>
                    ...
                    <div class="modal-body bg-white">
                        <form class="row g-3 needs-validation" novalidate>
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="txtModalIdAlumno" placeholder="id alumno"
                                    required>
                                <input type="hidden" class="form-control" id="txtModalIdUsuarioUpdate"
                                    placeholder="id alumno" required>
                                <div class="invalid-feedback">El Id es nesesario</div>
                            </div>
                            <div class="col-md-6">
                                <label for="">No. de Cuenta</label>
                                <input type="text" class="form-control" id="txtModalNoCuenta"
                                    placeholder="No. de Cuenta" required>
                                <div class="invalid-feedback">El numero de cuenta es nesesario</div>
                                <input type="hidden" class="form-control" id="txtModalNoCuentaUsuarioUpdate"
                                    placeholder="No. de Cuenta Usuario" required>
                            </div>
                            <div class="col-md-6">
                                <label for="">Nombre del Alumno</label>
                                <input type="text" class="form-control" id="txtModalNombreAlumno"
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="txtModalAPAlumno"
                                    placeholder="Apellido Paterno" required>
                                <div class="invalid-feedback">El apellido paterno del alumno es nesesario</div>
                            </div>
                            <div class="col-md-6">
                                <label for="">Apellido Materno del alumno</label>
                                <input type="text" class="form-control" id="txtModalAMAlumno"
                                    placeholder="Apellido Materno" required>
                                <div class="invalid-feedback">El apellido materno del alumno es nesesario</div>
                            </div>
                            <div class="form-group col-6">
                                <label for="">Genero</label>
                                <select id="SelectModalGeneroAlumno" class="custom-select" placeholder="Seleccionar..."
                                    required>
                                    <option>Seleccionar...</option>
                                    <option>F</option>
                                    <option>M</option>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" class="form-control" id="txtModalTelAlumno"
                                    placeholder="Teléfono Alumno" required>
                                <div class="invalid-feedback">El Teléfono del alumno es nesesario</div>
                            </div>
                            <div class="col-md-6">
                                <label for="">E-mail del alumno</label>
                                <input type="text" class="form-control" id="txtModalEmailAlumno"
                                    placeholder="E-mail Alumno" required>
                                <div class="invalid-feedback">El email del alumno es nesesario</div>
                            </div>
                        </form>
                    </div>
                    <div class="modal-footer" style="text-align: center;">
                        <button type="button" class="btn btn-primary" id='btnModalEditarAlumno' data-dismiss="modal"><i
                                class='far fa-edit'></i> Actualizar Información</button>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-12">
                <form class="row g-3 needs-validation" novalidate>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="password" class="form-control" id="txtPasswordAsesor" placeholder="Contraseña"
                            required>
                        <div class="invalid-feedback">La contraseña es nesesaria</div>
                    </div>
                    <div class="col-md-6">
                        <label for="txtNombreAsesor">Nombre del Asesor</label>
                        <input type="text" class="form-control" id="txtNombreAsesor" placeholder="Nombre del Asesor"
                            required>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="txtAPAsesor" placeholder="Apellido Paterno"
                            required>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="txtAMAsesor" placeholder="Apellido Materno"
                            required>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" class="form-control" id="txtTelAsesor" placeholder="Teléfono Asesor"
                            required>
                        <div class="invalid-feedback">El Teléfono del Asesor es nesesario</div>
                    </div>
                    <div class="col-md-6">
                        <label for="txtEmailAsesor">E-mail del Asesor</label>
                        <input type="text" class="form-control" id="txtEmailAsesor" placeholder="E-mail Asesor"
                            required>
        ...
        <!--Modal Editar Asesor-->
        <div class="modal fade" id="ModalEditarAsesor" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content bg-white">
                    <div class="modal-header">
                    ...
                    <div class="modal-body bg-white">
                        <form class="row g-3 needs-validation" novalidate>
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="txtModalIdAsesor" placeholder="id asesor"
                                    required>
                                <input type="hidden" class="form-control" id="txtModalIdUsuarioAsesorUpdate"
                                    placeholder="id asesor" required>
                                <div class="invalid-feedback">El Id es nesesario</div>
                            </div>
                            <div class="col-md-6">
                                <label for="">Clave</label>
                                <input type="text" class="form-control" id="txtModalClave" placeholder="Clave" required>
                                <input type="hidden" class="form-control" id="txtModalClaveusuarioUpdate"
                                    placeholder="Clave" required>
                                <div class="invalid-feedback">La Clave es nesesaria</div>
                            </div>
                            <div class="col-md-6">
                                <label for="">Nombre del Asesor</label>
                                <input type="text" class="form-control" id="txtModalNombreAsesor"
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="txtModalAPAsesor"
                                    placeholder="Apellido Paterno" required>
                                <div class="invalid-feedback">El apellido paterno del Asesor es nesesario</div>
                            </div>
                            <div class="col-md-6">
                                <label for="">Apellido Materno del Asesor</label>
                                <input type="text" class="form-control" id="txtModalAMAsesor"
                                    placeholder="Apellido Materno" required>
                                <div class="invalid-feedback">El apellido materno del Asesor es nesesario</div>
                            </div>
                            <div class="col-md-6">
                                <label for="">Telefono del Asesor</label>
                                <input type="number" class="form-control" id="txtModalTelAsesor"
                                    placeholder="Teléfono Asesor" required>
                                <div class="invalid-feedback">El Teléfono del Asesor es nesesario</div>
                            </div>
                            <div class="col-md-6">
                                <label for="">E-mail del Asesor</label>
                                <input type="text" class="form-control" id="txtModalEmailAsesor"
                                    placeholder="E-mail Asesor" required>
                                <div class="invalid-feedback">El email del Asesor es nesesario</div>
                            </div>
                        </form>
                    </div>
                    <div class="modal-footer" style="text-align: center;">
                        <button type="button" class="btn btn-primary" id='btnModalEditarAsesor' data-dismiss="modal"><i
                                class='far fa-edit'></i> Actualizar Información</button>
                    </div>
                </div>
            </div>
        ...
        <div class="modal fade" id="ModalEditarUsuario" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content bg-white">
                    <div class="modal-header">
                        <h5 class="modal-title" style="text-align: center;" id="exampleModalLabel">Editar Contraseña
                        </h5><br>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    ...
                    <div class="modal-body bg-white">
                        <form class="row g-3 needs-validation" novalidate>
                            <label for="" style="text-align: center;">Para Modificar el Usuario, por favor modificalo
                                desde la tabla de alumnos o asesores</label>
                            <div class="col-md-6">
                                <label for="">Id Usuario</label>
                                <input type="text" class="form-control" id="txtModalIdUsuario" placeholder="id Usuario"
                                    required>
                                <div class="invalid-feedback">El Id es nesesario</div>
                            </div>
                            <div class="col-md-6">
                                <label for="">Usuario</label>
                                <input type="text" class="form-control" id="txtModalUsuario" placeholder="Usuario"
                                    required>
                                <div class="invalid-feedback">El Usuario es nesesario</div>
                            </div>
                            <div class="col-md-6">
                                <label for="">Contraseña</label>
                                <input type="text" class="form-control" id="txtModalPasswordUsuario"
                    ...
                    <div class="modal-footer" style="text-align: center;">
                        <button type="button" class="btn btn-primary" id='btnModalEditarUsuario' data-dismiss="modal"><i
                                class='far fa-edit'></i> Actualizar Información</button>
                    </div>
                </div>
            </div>
        ...
        <div class="row" id="divAgregarTrabajo" style="display: none;">
            <div class="col-12" style="text-align: center;">
                ...
                <h1 class="animate__animated animate__backInLeft">
                    <font color="black" size="7">
                        <b>REGISTRO DE TRABAJOS DE ALUMNOS</b>
                    </font>
                </h1>
            </div>
            <div class="col-12">
                <form class="row g-3 needs-validation" name="formulario-enviar" id="formulario-enviar"
                    enctype="multipart/form-data" method="post" novalidate>
                    <div class="col-md-12">
                        <label for="txtNombreTrabajo">Nombre del Proyecto o trabajo</label>
                        <textarea class="form-control" id="txtNombreTrabajo" name="txtNombreTrabajo" rows="3"
                            placeholder="Nombre del Trabajo" required></textarea>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="txtCuentaAlumnoTrabajo"
                            name="txtCuentaAlumnoTrabajo" placeholder="No. de Cuenta del alumno" required>
                        <div id="labelNoCuenta" class="col-form-label"></div>
                        <div class="invalid-feedback">El No.Cuenta es nesesario</div>
                    </div>
                    <div class="col-md-6">
                        <label for="txtAsesorTrabajo">Clave del Asesor</label>
                        <input type="text" class="form-control" id="txtAsesorTrabajo" name="txtAsesorTrabajo" placeholder="Clave del Asesor"
                            required>
                            <div id="labelAsesor" class="col-form-label"></div>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="txtTipoTrabajo" name="txtTipoTrabajo" placeholder="Tipo" required>
                        <div class="invalid-feedback">El tipo del Trabajo es nesesario</div>
                    </div>
                    <div class="form-group col-6">
                        <label for="SelectMesTrabajo">Mes</label>
                        <select id="SelectMesTrabajo" name="SelectMesTrabajo" class="custom-select" placeholder="Seleccionar..." required>
                            <option>Seleccionar...</option>
                            <option>Enero</option>
                    ...
                    <div class="form-group col-6">
                        <label for="SelectAñoTrabajo">Año</label>
                        <select id="SelectAñoTrabajo" name="SelectAñoTrabajo" class="custom-select" placeholder="Seleccionar..." required>
                            <option>Seleccionar...</option>
                            <option>2030</option>
                            <option>2029</option>
                            <option>2028</option>
                    ...
                    <div class="form-group col-6">
                        ...
                        <div class="invalid-feedback">El archivo es nesesario</div>
                    </div>
                    <div class="col-12 text-center">
                        <br>
                        <br>
                ...
                <script src="js/FuncionesTrabajos.js"></script>
            </div>
        </div>
        <!--Modal Editar Trabajo-->
        <div class="modal fade" id="ModalEditarTrabajo" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content bg-white">
                    <div class="modal-header">
                    ...
                    <div class="modal-body bg-white">
                    <form class="needs-validation" name="formulario-enviar-Modal" id="formulario-enviar-Modal"
                    enctype="multipart/form-data" method="post" novalidate>
                    ...
                    <div class="form-group">
                        <label for="txtModalNombreTrabajo">Nombre del Proyecto o trabajo</label>
                        <textarea class="form-control" id="txtModalNombreTrabajo" name="txtModalNombreTrabajo" rows="3"
                            placeholder="Nombre del Trabajo" required></textarea>
                        <div class="invalid-feedback">El nombre Trabajo es nesesario</div>
                    </div>
                    <div class="form-group">
                        <label for="txtModalCuentaAlumnoTrabajo">No. de cuenta del alumno</label>
                        <input type="text" class="form-control" id="txtModalCuentaAlumnoTrabajo"
                            name="txtModalCuentaAlumnoTrabajo" placeholder="No. de Cuenta del alumno" required>
                        <div class="invalid-feedback">El apellido materno del Asesor es nesesario</div>
                    </div>
                    <div class="form-group">
                        <label for="txtModalAsesorTrabajo">Clave del Asesor</label>
                        <input type="text" class="form-control" id="txtModalAsesorTrabajo" name="txtModalAsesorTrabajo" placeholder="Clave del Asesor"
                            required>
                        <div class="invalid-feedback">La clave del Asesor del trabajo es nesesaria</div>
                    </div>
                    <div class="form-group">
                        <label for="txtModalTipoTrabajo">Tipo de trabajo</label>
                        <input type="text" class="form-control" id="txtModalTipoTrabajo" name="txtModalTipoTrabajo" placeholder="Tipo" required>
                        <div class="invalid-feedback">El tipo del Trabajo es nesesario</div>
                    </div>
                    <div class="form-group">
                        <label for="SelectMesTrabajoModal">Mes</label>
                        <select id="SelectMesTrabajoModal" name="SelectMesTrabajoModal" class="custom-select" placeholder="Seleccionar..." required>
                            <option>Seleccionar...</option>
                            <option>Enero</option>
                            <option>Febrero</option>
                            <option>Marzo</option>
                    ...
                    <div class="form-group">
                        <label for="SelectAñoTrabajoModal">Año</label>
                        <select id="SelectAñoTrabajoModal" name="SelectAñoTrabajoModal" class="custom-select" placeholder="Seleccionar..." required>
                            <option>Seleccionar...</option>
                            <option>2030</option>
                            <option>2029</option>
                            <option>2028</option>
                    ...
                    <div class="form-group">
                        <label for="">Subir Archivo</label>
                        <input type="file" class="form-control" id="archivoModal" name="archivoModal" required>
                        <div class="invalid-feedback">El archivo es nesesario</div>
                    </div>
                </form>
                    </div>
                    <div class="modal-footer" style="text-align: center;">
                        <button type="button" class="btn btn-primary" id='btnModalEditarTrabajo' data-dismiss="modal"><i
                                class='far fa-edit'></i> Actualizar Información</button>
                    </div>
                </div>
            </div>
