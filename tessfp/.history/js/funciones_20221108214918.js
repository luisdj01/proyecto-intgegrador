$(document).ready(function(){
    ...
    $("#btnModalEditarTrabajo").click(function(event){
        ...
        $.ajax({
            url:"./php/servidor.php",
            type:"GET",
            data:{accion:accion,id_proyectoM:id_proyectoM,nombreTrabajoM:nombreTrabajoM, tipoM:tipoM, nocuentaAlumnoTrabajoM:nocuentaAlumnoTrabajoM, 
