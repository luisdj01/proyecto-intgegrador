$(document).ready(function(){
    ...
    $("#btnModalEditarTrabajo").click(function(event){
        ...
        mesM = $("#SelectMesTrabajoModal");
        añoM = $("#SelectAñoTrabajoModal");
        ...
        $.ajax({
            url:"./php/servidor.php",
            type:"GET",
            data:{accion:accion,id_proyectoM:id_proyectoM,nombreTrabajoM:nombreTrabajoM, mesM:mesM, añoM:tipoM:tipoM, nocuentaAlumnoTrabajoM:nocuentaAlumnoTrabajoM, 
