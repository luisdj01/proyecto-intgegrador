        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark" id="Nav">
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav">
                    ...
                    <a class="nav-link" href="#" id="menuTrabajosAlumno" style="color: white;">
                    <span class="fas fa-book"></span> Trabajos </a>
                    <li class="nav-item dropdown" >
                        <a class="nav-link dropdown-toggle" href="" data-toggle="dropdown" style="color: white;">
                            <span class="fas fa-users"></span> Alumnos y Asesores
                        </a>
                        <div class="dropdown-menu">
                            <a class="dropdown-item" href="#" id="menuMostarAlumno2"><span class="fas fa-user-graduate"></span> Alumnos</a>
                            <a class="dropdown-item" href="#" id="menuMostrarAsesor2"><span class="fas fa-chalkboard-teacher"></span> Asesor</a>
                        </div>
                    </li>
