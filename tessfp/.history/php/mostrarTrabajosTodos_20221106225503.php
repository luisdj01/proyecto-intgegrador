...
<th>No de cuenta del Alumno</th><th>Nombre del Alumno</th><th>Asesor</th><th>Elininar</th><th>Editar</th></thead>";
while($fila=$ejecutarConsulta->fetch_array()){
    ...
    <p class='btn btn-warning' onclick='eliminarTrabajos(".$fila[0].")'>
