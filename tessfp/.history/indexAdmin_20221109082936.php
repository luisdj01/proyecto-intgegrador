...
<body>
    ...
    <div class="container">
        ...
        <div class="modal fade" id="ModalEditarAlumno" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-lg" role="document" style="text-align: center;">
            ...
            <div class="modal-dialog" role="document">
                ...
                <div class="modal-body bg-white">
                    <form class="needs-validation" novalidate>
                        ...
                        <div class="form-group">
                        <label for="SelectMesTrabajo">Mes</label>
                        <select id="SelectMesTrabajoModal" class="custom-select" placeholder="Seleccionar..." required> 
                            <option>Seleccionar...</option>
                            <option>Enero</option> 
                            <option>Febrero</option> 
                            <option>Marzo</option> 
                    ...
                    <div class="form-group">
                        <label for="SelectAñoTrabajo">Año</label>
                        <select id="SelectAñoTrabajoModal" class="custom-select" placeholder="Seleccionar..." required> 
                            <option>Seleccionar...</option>
                            <option>2030</option>
                            <option>2029</option>
                            <option>2028</option>
